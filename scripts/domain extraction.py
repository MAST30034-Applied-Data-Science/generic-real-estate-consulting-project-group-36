...
for i in range(0, pages):
    ...
    get_html("https://www.domain.com.au/rent/melbourne-vic-3000/?ptype=apartment-unit-flat,block-of-units,duplex,free-standing,new-apartments,new-home-designs,new-house-land,pent-house,semi-detached,studio,terrace,villa&excludedeposittaken=%d&page=%d" % (page, page))
